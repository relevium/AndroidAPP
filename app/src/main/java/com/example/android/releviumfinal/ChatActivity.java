...
public class ChatActivity extends AppCompatActivity {
    ...
    private ClientMessageAdapter messageAdapter;
    ...
    {
        SendMessageButton = findViewById(R.id.client_btn_text);

        MessageInputText = findViewById(R.id.client_editText);

        messageAdapter = new ClientMessageAdapter(messagesList);
