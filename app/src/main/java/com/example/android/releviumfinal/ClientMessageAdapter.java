...
public class ClientMessageAdapter extends RecyclerView.Adapter<ClientMessageAdapter.MessageViewHolder>
{
    ...
    public ClientMessageAdapter (List<Messages> userMessagesList)
    {
        ...
        usersRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot)
            {
                if (dataSnapshot.hasChild("image"))
                {
                    ...
                    Picasso.get().load(receiverImage).placeholder(R.drawable.relevium).into(messageViewHolder.receiverProfileImage);
                }
            }
